    ...
    <section className="h-screen py-16 bg-gray-100 flex  flex-col">
      <div className="container 2xl:px-10 mx-auto flex flex-col gap-16">
        ...
        <div className="space-y-3">
          <h2 className="text-2xl md:text-4xl ml-3 md:ml-0 font-sora font-semibold">
            Featured Article
          </h2>
          <div className="bg-gradient-to-r from-transparent via-accent to-transparent h-0.5 max-w-3xs md:max-w-2xs"></div>
        </div>
        {/* content */}
        <div className="grid md:grid-cols-2 gap-6 bg-gradient-to-br from-indigo-200/20 to-purple-200/20  p-6 rounded-xl border border-border/70 hover:shadow-lg transition-all duration-200">
          {/* LEFT */}
