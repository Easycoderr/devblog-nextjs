    ...
    <section className="h-screen bg-gray-50 pb-16 flex items-center">
      <div className="container 2xl:px-10 mx-auto">
        <div className="flex items-center justify-center flex-col gap-8">
          <h1 className="font-sora text-4xl md:text-5xl tracking-tight font-semibold md:font-bold text-center bg-gradient-to-l from-indigo-500 via-purple-600 to-indigo-400 bg-clip-text text-transparent">
            Write Better Code. Share Better Ideas.
          </h1>
          <p className="leading-relaxed tracking-wide text-lg text-center max-w-3xl">
