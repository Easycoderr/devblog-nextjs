function AboutCard({ item }) {
  ...
  return (
    <div
      className={`border border-border space-y-3 bg-card py-5 px-4 shadow-sm rounded-xl hover:scale-100 hover:-translate-y-1 hover:shadow-lg transition-all duration-200`}
    >
